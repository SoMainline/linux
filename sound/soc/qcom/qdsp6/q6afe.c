...
static struct afe_port_map port_maps[AFE_PORT_MAX] = {
	...
	[SENARY_TDM_RX_0] =  { AFE_PORT_ID_SENARY_TDM_RX,
				SENARY_TDM_RX_0, 1, 1},
	[SENARY_TDM_TX_0] =  { AFE_PORT_ID_SENARY_TDM_TX,
				SENARY_TDM_TX_0, 0, 1},
	[SENARY_TDM_RX_1] =  { AFE_PORT_ID_SENARY_TDM_RX_1,
				SENARY_TDM_RX_1, 1, 1},
	[SENARY_TDM_TX_1] =  { AFE_PORT_ID_SENARY_TDM_TX_1,
				SENARY_TDM_TX_1, 0, 1},
	[SENARY_TDM_RX_2] =  { AFE_PORT_ID_SENARY_TDM_RX_2,
				SENARY_TDM_RX_2, 1, 1},
	[SENARY_TDM_TX_2] =  { AFE_PORT_ID_SENARY_TDM_TX_2,
				SENARY_TDM_TX_2, 0, 1},
	[SENARY_TDM_RX_3] =  { AFE_PORT_ID_SENARY_TDM_RX_3,
				SENARY_TDM_RX_3, 1, 1},
	[SENARY_TDM_TX_3] =  { AFE_PORT_ID_SENARY_TDM_TX_3,
				SENARY_TDM_TX_3, 0, 1},
	[SENARY_TDM_RX_4] =  { AFE_PORT_ID_SENARY_TDM_RX_4,
				SENARY_TDM_RX_4, 1, 1},
	[SENARY_TDM_TX_4] =  { AFE_PORT_ID_SENARY_TDM_TX_4,
				SENARY_TDM_TX_4, 0, 1},
	[SENARY_TDM_RX_5] =  { AFE_PORT_ID_SENARY_TDM_RX_5,
				SENARY_TDM_RX_5, 1, 1},
	[SENARY_TDM_TX_5] =  { AFE_PORT_ID_SENARY_TDM_TX_5,
				SENARY_TDM_TX_5, 0, 1},
	[SENARY_TDM_RX_6] =  { AFE_PORT_ID_SENARY_TDM_RX_6,
				SENARY_TDM_RX_6, 1, 1},
	[SENARY_TDM_TX_6] =  { AFE_PORT_ID_SENARY_TDM_TX_6,
				SENARY_TDM_TX_6, 0, 1},
	[SENARY_TDM_RX_7] =  { AFE_PORT_ID_SENARY_TDM_RX_7,
				SENARY_TDM_RX_7, 1, 1},
	[SENARY_TDM_TX_7] =  { AFE_PORT_ID_SENARY_TDM_TX_7,
				SENARY_TDM_TX_7, 0, 1},
...
struct q6afe_port *q6afe_port_get_from_id(struct device *dev, int id)
{
	...
	case AFE_PORT_ID_SENARY_MI2S_TX:
		...
		break;
	case AFE_PORT_ID_PRIMARY_TDM_RX ... AFE_PORT_ID_SENARY_TDM_TX_7:
