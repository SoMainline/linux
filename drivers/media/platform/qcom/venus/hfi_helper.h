...
#define HFI_PROPERTY_PARAM_VUI_DISPLAY_INFO_EXTRADATA		0x120301b
#define HFI_PROPERTY_PARAM_VDEC_VPX_COLORSPACE_EXTRADATA	0x120301d
#define HFI_PROPERTY_PARAM_VDEC_MASTER_DISP_COL_SEI_EXTRADATA	0x120301e
#define HFI_PROPERTY_PARAM_VDEC_CLL_SEI_EXTRADATA		0x120301f
#define HFI_PROPERTY_PARAM_VDEC_HDR10_HIST_EXTRADATA		0x1203023
