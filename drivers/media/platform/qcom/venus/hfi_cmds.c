			     ...
			     void *cookie, u32 ptype, void *pdata)
{
	...
	case HFI_PROPERTY_PARAM_S3D_FRAME_PACKING_EXTRADATA:
	case HFI_PROPERTY_PARAM_VDEC_CLL_SEI_EXTRADATA:
	case HFI_PROPERTY_PARAM_VDEC_FRAME_QP_EXTRADATA:
	case HFI_PROPERTY_PARAM_VDEC_FRAME_RATE_EXTRADATA:
	case HFI_PROPERTY_PARAM_VDEC_HDR10_HIST_EXTRADATA:
	case HFI_PROPERTY_PARAM_VDEC_INTERLACE_VIDEO_EXTRADATA:
	case HFI_PROPERTY_PARAM_VDEC_MASTER_DISP_COL_SEI_EXTRADATA:
	case HFI_PROPERTY_PARAM_VDEC_MPEG2_SEQDISP_EXTRADATA:
	case HFI_PROPERTY_PARAM_VDEC_NUM_CONCEALED_MB:
	case HFI_PROPERTY_PARAM_VDEC_PANSCAN_WNDW_EXTRADATA:
	case HFI_PROPERTY_PARAM_VDEC_RECOVERY_POINT_SEI_EXTRADATA:
	case HFI_PROPERTY_PARAM_VDEC_STREAM_USERDATA_EXTRADATA:
	case HFI_PROPERTY_PARAM_VDEC_TIMESTAMP_EXTRADATA:
	case HFI_PROPERTY_PARAM_VDEC_VPX_COLORSPACE_EXTRADATA:
	case HFI_PROPERTY_PARAM_VUI_DISPLAY_INFO_EXTRADATA:
	case HFI_PROPERTY_PARAM_INDEX_EXTRADATA: {
		struct hfi_index_extradata_config *in = pdata, *tm = prop_data;

		tm->enable = in->enable;
		tm->index_extra_data_id = in->index_extra_data_id;
		pkt->shdr.hdr.size += sizeof(u32) + sizeof(*tm);
		break;
	}
