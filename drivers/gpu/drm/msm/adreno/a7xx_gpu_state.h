...
static const u32 a7xx_pc_vs_cluster[] = {
...
static const struct a7xx_cluster {
	u32 id;
	const char *name;
	const u32 *registers;
	size_t count;
	...
	CLUSTER(CLUSTER_GRAS, a7xx_gras_cluster, 0, 0),
	CLUSTER(CLUSTER_PS, a7xx_ps_cluster_rac, REG_A6XX_RB_RB_SUB_BLOCK_SEL_CNTL_CD, 0x0),
	CLUSTER(CLUSTER_PS, a7xx_ps_cluster_rbp, REG_A6XX_RB_RB_SUB_BLOCK_SEL_CNTL_CD, 0x9),
	CLUSTER(CLUSTER_PS, a7xx_ps_cluster, 0, 0),
	CLUSTER(CLUSTER_FE, a7xx_fe_cluster, 0, 0),
	CLUSTER(CLUSTER_PC_VS, a7xx_pc_vs_cluster, 0, 0),
	CLUSTER(CLUSTER_FE, a660_fe_cluster, 0, 0),
};

static const u32 a7xx_sp_vs_hlsq_cluster[] = {
	0xb800, 0xb803, 0xb820, 0xb822,
};

static const u32 a7xx_sp_vs_sp_cluster[] = {
	0xa800, 0xa824, 0xa830, 0xa83c, 0xa840, 0xa864, 0xa870, 0xa895,
	0xa8a0, 0xa8af, 0xa8c0, 0xa8c3,
};

static const u32 a7xx_hlsq_duplicate_cluster[] = {
	0xbb10, 0xbb11, 0xbb20, 0xbb29,
};

static const u32 a7xx_hlsq_2d_duplicate_cluster[] = {
	0xbd80, 0xbd80,
};

static const u32 a7xx_sp_duplicate_cluster[] = {
	0xab00, 0xab00, 0xab04, 0xab05, 0xab10, 0xab1b, 0xab20, 0xab20,
};

static const u32 a7xx_tp_duplicate_cluster[] = {
	0xb300, 0xb307, 0xb309, 0xb309, 0xb380, 0xb382,
};

static const u32 a7xx_sp_ps_hlsq_cluster[] = {
	0xb980, 0xb980, 0xb982, 0xb987, 0xb990, 0xb99b, 0xb9a0, 0xb9a2,
	0xb9c0, 0xb9c9,
};

static const u32 a7xx_sp_ps_hlsq_2d_cluster[] = {
	0xbd80, 0xbd80,
};

static const u32 a7xx_sp_ps_sp_cluster[] = {
	0xa980, 0xa9a8, 0xa9b0, 0xa9bc, 0xa9d0, 0xa9d3, 0xa9e0, 0xa9f3,
	0xaa00, 0xaa00, 0xaa30, 0xaa31, 0xaaf2, 0xaaf2,
};

static const u32 a7xx_sp_ps_sp_2d_cluster[] = {
	0xacc0, 0xacc0,
};

static const u32 a7xx_sp_ps_tp_cluster[] = {
	0xb180, 0xb183, 0xb190, 0xb191,
};

static const u32 a7xx_sp_ps_tp_2d_cluster[] = {
	0xb4c0, 0xb4d1,
};
...
static const struct a7xx_dbgahb_cluster {
	const char *name;
	u32 statetype;
	u32 base;
	const u32 *registers;
	size_t count;
} a7xx_dbgahb_clusters[] = {
	CLUSTER_DBGAHB(CLUSTER_SP_VS, 0x0002e000, 0x41, a7xx_sp_vs_hlsq_cluster),
	CLUSTER_DBGAHB(CLUSTER_SP_VS, 0x0002a000, 0x21, a7xx_sp_vs_sp_cluster),
	CLUSTER_DBGAHB(CLUSTER_SP_VS, 0x0002e000, 0x41, a7xx_hlsq_duplicate_cluster),
	CLUSTER_DBGAHB(CLUSTER_SP_VS, 0x0002f000, 0x45, a7xx_hlsq_2d_duplicate_cluster),
	CLUSTER_DBGAHB(CLUSTER_SP_VS, 0x0002a000, 0x21, a7xx_sp_duplicate_cluster),
	CLUSTER_DBGAHB(CLUSTER_SP_VS, 0x0002c000, 0x1, a7xx_tp_duplicate_cluster),
	CLUSTER_DBGAHB(CLUSTER_SP_PS, 0x0002e000, 0x42, a7xx_sp_ps_hlsq_cluster),
	CLUSTER_DBGAHB(CLUSTER_SP_PS, 0x0002f000, 0x46, a7xx_sp_ps_hlsq_2d_cluster),
	CLUSTER_DBGAHB(CLUSTER_SP_PS, 0x0002a000, 0x22, a7xx_sp_ps_sp_cluster),
	CLUSTER_DBGAHB(CLUSTER_SP_PS, 0x0002b000, 0x26, a7xx_sp_ps_sp_2d_cluster),
	CLUSTER_DBGAHB(CLUSTER_SP_PS, 0x0002c000, 0x2, a7xx_sp_ps_tp_cluster),
	CLUSTER_DBGAHB(CLUSTER_SP_PS, 0x0002d000, 0x6, a7xx_sp_ps_tp_2d_cluster),
	CLUSTER_DBGAHB(CLUSTER_SP_PS, 0x0002e000, 0x42, a7xx_hlsq_duplicate_cluster),
	CLUSTER_DBGAHB(CLUSTER_SP_PS, 0x0002a000, 0x22, a7xx_sp_duplicate_cluster),
	CLUSTER_DBGAHB(CLUSTER_SP_PS, 0x0002c000, 0x2, a7xx_tp_duplicate_cluster),
};

static const u32 a7xx_hlsq_registers[] = {
	0xbe00, 0xbe01, 0xbe04, 0xbe05, 0xbe08, 0xbe09, 0xbe10, 0xbe15,
	0xbe20, 0xbe23,
};

static const u32 a7xx_sp_registers[] = {
	0xae00, 0xae04, 0xae0c, 0xae0c, 0xae0f, 0xae2b, 0xae30, 0xae32,
	0xae35, 0xae35, 0xae3a, 0xae3f, 0xae50, 0xae52,
};

static const u32 a7xx_tp_registers[] = {
	0xb600, 0xb601, 0xb604, 0xb605, 0xb610, 0xb61b, 0xb620, 0xb623,
};

struct a7xx_registers {
	const u32 *registers;
	size_t count;
	u32 val0;
	u32 val1;
...
static const struct a7xx_registers a7xx_hlsq_reglist[] = {
	HLSQ_DBG_REGS(0x0002F800, 0x40, a7xx_hlsq_registers),
	HLSQ_DBG_REGS(0x0002B800, 0x20, a7xx_sp_registers),
	HLSQ_DBG_REGS(0x0002D800, 0x0, a7xx_tp_registers),
};

#define SHADER(_type, _size) \
	{ .type = _type, .name = #_type, .size = _size }

static const struct a7xx_shader_block {
	const char *name;
	u32 type;
	u32 size;
} a7xx_shader_blocks[] = {
...
static const struct a7xx_registers a7xx_reglist[] = {
	REGS(a7xx_registers, 0, 0),
	REGS(a660_registers, 0, 0),
	REGS(a7xx_rb_rac_registers, REG_A6XX_RB_RB_SUB_BLOCK_SEL_CNTL_CD, 0),
	REGS(a7xx_rb_rbp_registers, REG_A6XX_RB_RB_SUB_BLOCK_SEL_CNTL_CD, 9),
};
...
static const u32 a7xx_vbif_registers[] = {
...
static const struct a7xx_registers a7xx_ahb_reglist[] = {
	REGS(a7xx_ahb_registers, 0, 0),
};

static const struct a7xx_registers a7xx_vbif_reglist =
			REGS(a7xx_vbif_registers, 0, 0);

static const struct a7xx_registers a7xx_gbif_reglist =
			REGS(a7xx_gbif_registers, 0, 0);

static const u32 a7xx_gmu_gx_registers[] = {
	/* GMU GX */
...
static const u32 a7xx_gmu_cx_registers[] = {
	/* GMU CX */
...
static const u32 a7xx_gmu_cx_rscc_registers[] = {
	/* GPU RSCC */
...
static const struct a7xx_registers a7xx_gmu_reglist[] = {
	REGS(a7xx_gmu_cx_registers, 0, 0),
	REGS(a7xx_gmu_cx_rscc_registers, 0, 0),
	REGS(a7xx_gmu_gx_registers, 0, 0),
};

static u32 a7xx_get_cp_roq_size(struct msm_gpu *gpu);

static struct a7xx_indexed_registers {
	const char *name;
	u32 addr;
	u32 data;
	u32 count;
...
static struct a7xx_indexed_registers a7xx_cp_mempool_indexed = {
...
static const struct a7xx_debugbus_block {
	const char *name;
	u32 id;
	u32 count;
} a7xx_debugbus_blocks[] = {
...
static const struct a7xx_debugbus_block a7xx_gbif_debugbus_block =
			DEBUGBUS(A6XX_DBGBUS_VBIF, 0x100);

static const struct a7xx_debugbus_block a7xx_cx_debugbus_blocks[] = {
	DEBUGBUS(A6XX_DBGBUS_GMU_CX, 0x100),
	DEBUGBUS(A6XX_DBGBUS_CX, 0x100),
};

static const struct a7xx_debugbus_block a650_debugbus_blocks[] = {
