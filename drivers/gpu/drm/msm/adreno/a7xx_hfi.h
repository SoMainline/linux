...
struct a7xx_hfi_queue_table_header {
	u32 version;
...
struct a7xx_hfi_queue {
	struct a7xx_hfi_queue_header *header;
	spinlock_t lock;
	u32 *data;
	atomic_t seqnum;
...
struct a7xx_hfi_msg_gmu_init_cmd {
	u32 header;
	u32 seg_id;
	u32 dbg_buffer_addr;
	u32 dbg_buffer_size;
...
struct a7xx_hfi_msg_fw_version {
	u32 header;
...
struct a7xx_hfi_msg_perf_table_v1 {
	u32 header;
	u32 num_gpu_levels;
	u32 num_gmu_levels;
...
struct a7xx_hfi_msg_perf_table {
	u32 header;
	u32 num_gpu_levels;
	u32 num_gmu_levels;
...
struct a7xx_hfi_msg_test {
	u32 header;
};

#define HFI_H2F_MSG_START 10

struct a7xx_hfi_msg_start {
	u32 header;
};

#define HFI_H2F_MSG_CORE_FW_START 14

struct a7xx_hfi_msg_core_fw_start {
	u32 header;
	u32 handle;
};
...
struct a7xx_hfi_gx_bw_perf_vote_cmd {
	u32 header;
	u32 ack_type;
	u32 freq;
	u32 bw;
...
struct a7xx_hfi_prep_slumber_cmd {
	u32 header;
	u32 bw;
	u32 freq;
};
