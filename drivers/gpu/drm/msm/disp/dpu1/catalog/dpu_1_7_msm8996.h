...
static const struct dpu_ubwc_cfg msm8996_ubwc_cfg = {
...
static const struct dpu_sspp_cfg msm8996_sspp[] = {
	{
		...
		.name = "sspp_16", .id = SSPP_CURSOR0,
		.base = 0x34000, .len = 0x150,
		.features = DMA_CURSOR_MSM8996_MASK,
		.sblk = &sdm845_dma_sblk_2,
		.xin_id = 7,
		.type = SSPP_TYPE_CURSOR,
		.clk_ctrl = DMA_CURSOR_MSM8996_MASK,
	},
	/* Both cursor planes share XIN ID 7 */
	{
		.name = "sspp_17", .id = SSPP_CURSOR1,
		.base = 0x36000, .len = 0x150,
		.features = DMA_CURSOR_MSM8996_MASK,
		.sblk = &sdm845_dma_sblk_3,
		.xin_id = 7,
		.type = SSPP_TYPE_CURSOR,
