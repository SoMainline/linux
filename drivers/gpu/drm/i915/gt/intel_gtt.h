...
#define PPAT_UNCACHED			(_PAGE_IOREMAP)
#define PPAT_CACHED_PDE			(_PAGE_IOREMAP) /* WB LLC */
#define PPAT_CACHED			(_PAGE_IOREMAP) /* WB LLCeLLC */
#define PPAT_DISPLAY_ELLC		(_PAGE_IOREMAP) /* WT eLLC */
