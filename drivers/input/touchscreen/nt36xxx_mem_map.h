...
struct nvt_ts_mem_map {
	...
	u32 RAW_PIPE1_ADDR;
	u32 BASELINE_ADDR;
	u32 BASELINE_BTN_ADDR;
	u32 DIFF_PIPE0_ADDR;
	u32 DIFF_PIPE1_ADDR;
	u32 RAW_BTN_PIPE0_ADDR;
	u32 RAW_BTN_PIPE1_ADDR;
	u32 DIFF_BTN_PIPE0_ADDR;
	u32 DIFF_BTN_PIPE1_ADDR;
	u32 PEN_2D_BL_TIP_X_ADDR;
	u32 PEN_2D_BL_TIP_Y_ADDR;
	u32 PEN_2D_BL_RING_X_ADDR;
	u32 PEN_2D_BL_RING_Y_ADDR;
	u32 PEN_2D_DIFF_TIP_X_ADDR;
	u32 PEN_2D_DIFF_TIP_Y_ADDR;
	u32 PEN_2D_DIFF_RING_X_ADDR;
	u32 PEN_2D_DIFF_RING_Y_ADDR;
	u32 PEN_2D_RAW_TIP_X_ADDR;
	u32 PEN_2D_RAW_TIP_Y_ADDR;
	u32 PEN_2D_RAW_RING_X_ADDR;
	u32 PEN_2D_RAW_RING_Y_ADDR;
	u32 PEN_1D_DIFF_TIP_X_ADDR;
	u32 PEN_1D_DIFF_TIP_Y_ADDR;
	u32 PEN_1D_DIFF_RING_X_ADDR;
	u32 PEN_1D_DIFF_RING_Y_ADDR;
	u32 READ_FLASH_CHECKSUM_ADDR;
	u32 RW_FLASH_DATA_ADDR;
	...
	u32 R_DLM_CHECKSUM_ADDR;
	u32 BLD_CRC_EN_ADDR;
	u32 DMA_CRC_EN_ADDR;
	u32 BLD_ILM_DLM_CRC_ADDR;
	u32 DMA_CRC_FLAG_ADDR;
};
