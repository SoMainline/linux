...
static const struct qcom_icc_qos_data bimc_qos_data[] = {
	{
		...
		.urg_fwd_en = false,
		.limit_commands = false,
		.node_idx = MASTER_GFX3D,
	}, {
		.qos_port = 2,
		.qos_mode = NOC_QOS_MODE_BYPASS,
		.node_idx = MASTER_SNOC_BIMC_RT,
	}, {
		.qos_port = 3,
		.qos_mode = NOC_QOS_MODE_BYPASS,
		.node_idx = MASTER_SNOC_BIMC_NRT,
	}, {
		.qos_port = 4,
		.qos_mode = NOC_QOS_MODE_FIXED,
		.areq_prio = 6,
		...
		.urg_fwd_en = false,
		.limit_commands = false,
		.node_idx = MASTER_TCU_0,
	}, {
		.qos_port = 6,
		.qos_mode = NOC_QOS_MODE_BYPASS,
		.node_idx = MASTER_SNOC_BIMC,
	},
};
